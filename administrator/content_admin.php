...
if ($_GET['module']=='home'){
  if ($_SESSION['leveluser']=='admin'){
          ...
          ?>
          <br>
         <center><h3>MENU UTAMA</h3></center>
        <section class="icons">
          <ul>
            <li>
              <a href="?module=admin">
                <img src="images/menu/admin1.png" height="50px"; width="50px"/>
                <span>Admin</span>
              </a>
            </li>
            <li>
              <a href="?module=admin&act=pengajar">
                <img src="images/menu/guru.png" height="50px"; width="50px" />
                <span>Pengajar</span>
              </a>
            </li>
            ...
            <li>
              <a href="?module=modul">
                <img src="images/menu/modul.png" height="50px"; width="50px"/>
                <span>Module</span>
              </a>
            </li>
            <li>
              <a href="?module=kelas">
                <img src="images/menu/kelas.png" height="50px"; width="50px" />
                <span>Kelas</span>
              </a>
            </li>
            <li>
              <a href="?module=matapelajaran">
                <img src="images/menu/mapel.png" height="50px"; width="50px"/>
                <span>MAPEL</span>
              </a>
            </li>
            <li>
              <a href="?module=materi">
                <img src="images/menu/materi.png" height="50px"; width="50px"/>
                <span>Materi</span>
              </a>
            </li>
            <li>
              <a href="?module=quiz">
                <img src="images/menu/tugas.png" height="50px"; width="50px"/>
                <span>Tugas</span>
              </a>
            </li>           
          </ul>
  ...
  elseif ($_SESSION['leveluser']=='pengajar'){
        ...
        <br><br><br><br><br><br>
         ...
         //kelas yang diampu
         echo"<form><fieldset>
              <legend>Kelas Yang diampu</legend>
              <dl class='inline'>
         ...
         if (!empty($ketemu)){
                ...
                <tr><th>No</th><th>Kelas</th><th>Wali Kelas</th><th>Ketua Kelas</th><th>Opsi</th></tr></thead>";
                ...
                while ($r=mysql_fetch_array($tampil_kelas)){
                    ...
                    echo "<td><a href='?module=kelas&act=editkelas&id=$r[id]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                    <a href=javascript:confirmdelete('$aksi_kelas?module=kelas&act=hapuswalikelas&id=$r[id]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a> |
                     <a href=?module=daftarsiswa&act=lihatmurid&id=$r[id_kelas] title='lihat siswa'><img src='images/icons/view.png' alt='view' /></a>
                    ";
                $no++;
                }
  ...
  if (!empty($cek_mapel)){
    echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Nama</th><th>Kelas</th><th>Pengajar</th><th>Deskripsi</th><th>Opsi</th></tr></thead>";
    $no=1;
    while ($r=mysql_fetch_array($tampil_pelajaran)){
       echo "<tr><td>$no</td>             
             ...
             <td><a href='?module=matapelajaran&act=editmatapelajaran&id=$r[id]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
             <a href=javascript:confirmdelete('$aksi_mapel?module=matapelajaran&act=hapus_mapel_pengajar&id=$r[id]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a>";
      $no++;
    }
    echo "</table></dl></fieldset></form>";
  }else{
