...
switch($_GET[act]){
  ...
  default:
      ...
      if ($_SESSION[leveluser]=='admin'){    
        echo "<br><center><h3>Manajemen Tugas & Quiz</h3><hr></center>
          <input type=button class='button blue' value='Tambah' onclick=\"window.location.href='?module=quiz&act=tambahtopikquiz';\">";
    ...
    while ($r=mysql_fetch_array($tampil_topik)){
      ...
      $tgl_buat   = tgl_indo($r[tgl_buat]);
       echo "<tr><td>$no</td>
             ...
             <td><ul><li><a href='?module=quiz&act=edittopikquiz&id=$r[id_tq]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> | 
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapustopikquiz&id=$r[id_tq]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a></li>
                 <li><a href=?module=buatquiz&act=buatquiz&id=$r[id_tq]>Buat Tugas</a></li>
                 <li><a href=?module=daftarquiz&act=daftarquiz&id=$r[id_tq]>Daftar Tugas</a></li>
    ...
    $tampil_topik = mysql_query("SELECT * FROM topik_quiz WHERE pembuat = '$_SESSION[idpengajar]'");
        echo "<center><h2>Daftar Tugas</h2><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=quiz&act=tambahtopikquiz';\">";
        echo "<br><br><table id='table1' class='gtable sortable'><thead>
        ...
        echo "<tr><td>$no</td>
             ...
             <td>$r[info]</td>
             <td><p align='center'>$r[terbit]</p></td>
             <td><a href='?module=quiz&act=edittopikquiz&id=$r[id_tq]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /> | 
                         <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapustopikquiz&id=$r[id_tq]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a><br><br>
                 <input type=button class='button small white' value='Buat Tugas' onclick=\"window.location.href='?module=buatquiz&act=buatquiz&id=$r[id_tq]';\"></input><br>
                <input type=button class='button small white' value='Daftar Tugas' onclick=\"window.location.href='?module=daftarquiz&act=daftarquiz&id=$r[id_tq]';\"></input><br>
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_mapel)){
            echo"<br><center><h2>Tugas / Quiz</b><br><p class='garisbawah'></p></h2></center>
            <table>
...
case "daftarsiswayangtelahmengerjakan":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<input class='button blue' type=button value=Cetak onclick=\"window.location.href='cetak-nilai.php';\">";
...
case "daftartopik":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        if (!empty($cek_topik)){
            echo"<br><center><h2>Daftar Tugas / Quiz Mata Pelajaran $data_mapel[nama]</b><br><p class='garisbawah'></p></h2></center>
              <table>
...
case "infokerjakan":
    if ($_SESSION[leveluser]=='siswa'){
        ...
        echo"<br><h2>Informasi</b><br><p class='garisbawah'></p></h2>
            ...
            2. Kerjakan soal dengan sebenar-benarnya<br>
            3. Tidak ada yang boleh Mencontek.<br>";
        echo"<p class='garisbawah'></p>
            <input type=submit class='tombol' value='Mulai' onclick='window.location.reload()'>
...
case "buatquizpilganda":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo"
             <center><legend>Buat Tugas/Quiz Pilihan Ganda</legend></center><br>
             <dl class='inline'>
             <dt><label>Pertanyaan ".$jumlah." </label></dt> <dd><textarea name='pertanyaan' id='wysiwyg' cols='75' rows='3'></textarea></dd>
...
case "daftarquiz":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "<form><fieldset>
          ...
          <input type=button class='button white' value='Daftar Tugas Pilihan Ganda' onclick=\"window.location.href='?module=daftarquizpilganda&act=daftarquizpilganda&id=$t[id_tq]';\">
          </p>
        ...
        echo "<form><fieldset>
          ...
          <p align=center'>
          <input class='button white' type=button value='Daftar Tugas Esay' onclick=\"window.location.href='?module=daftarquizesay&act=daftarquizesay&id=$t[id_tq]';\">
          <input class='button white' type=button value='Daftar Tugas Pilihan Ganda' onclick=\"window.location.href='?module=daftarquizpilganda&act=daftarquizpilganda&id=$t[id_tq]';\">
          </p>
          <br><input type=button class='button blue' value=Kembali onclick=self.history.back()>
          </fieldset></form>";
    }
...
case "daftarquizesay":
    ...
    while ($q=mysql_fetch_array($quiz)){
       ...
       echo "<tr><td>$no</td>
             ...
             <td>$q[gambar]</td>
             <td>$tgl_buat</td>
             <td><a href='?module=quiz&act=editquizesay&id=$q[id_quiz]&id_topik=$q[id_tq]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapusquizesay&id=$q[id_quiz]&id_topik=$q[id_tq]') title='Hapus' ><img src='images/icons/delete1.png' alt='Delete' /></a>
                 </td></tr>";
      $no++;
    }
    echo "</table>";
    ...
    while ($q=mysql_fetch_array($quiz)){
       echo "<tr><td rowspan=8><b>$no.</b></td>
		    ...
		    <div>
             ...
             <tr><td>Aksi</td><td>: <a href='?module=quiz&act=editquizpilganda&id=$q[id_quiz]&id_topik=$q[id_tq]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=quiz&act=hapusquizpilganda&id=$q[id_quiz]&id_topik=$q[id_tq]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a></td></tr>
             ";
      $no++;
    }
    echo "</table>";
