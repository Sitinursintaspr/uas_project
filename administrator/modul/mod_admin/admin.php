...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<center><h3>Pengelolaan Data Admin</h3><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=admin&act=tambahadmin';\">";
          ...
          <tr><th>No</th><th>Username</th><th>Nama</th><th>Alamat</th><th>Email</th><th>Telp/HP</th><th>Aktif</th><th>Aksi</th></tr></thead>";
    $no=1;
    while ($r=mysql_fetch_array($tampil_admin)){
       echo "<tr><td>$no</td>
             ...
             <td><a href='?module=admin&act=editadmin&id=$r[id_session]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a></td></tr>";
      $no++;
    }
    echo "</table>";
    }
  ...
  if ($_SESSION[leveluser]=='admin'){
    ...
    echo "<center><h3>Pengelolaan Data Pengajar</h3><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=admin&act=tambahpengajar';\">";
          echo" <input class='button blue' type=button value='cetak' onclick=\"window.location.href='cetak-guru.php';\">";

          echo "<br><br><table id='table1' class='gtable sortable'><thead>
          <tr><th>No</th><th>Nip</th><th>Username</th><th>Nama</th><th>Aktif</th><th>Aksi</th></tr></thead>";
    ...
    while ($r=mysql_fetch_array($tampil_pengajar)){
       echo "<tr><td>$no</td>
             ...
             <td>$r[nama_lengkap]</td>             
		         <td align=center>$r[blokir]</td>
             <td><a href='?module=admin&act=editpengajar&id=$r[id_pengajar]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
  ...
  case "tambahadmin":
    ...
    echo "<form class='uniform' method=POST action='$aksi?module=admin&act=input_admin'>
          ...
          <dt><label>Aktif</label></dt>       <dd> : <input type=radio name='blokir' value='Y'> Y
  ...
  case "editadmin":
    ...
    if ($r[blokir]=='N'){
      echo "<dt><label>Aktif</label></dt>     <dd> : <input type=radio name='blokir' value='Y'> Y
                                                      <input type=radio name='blokir' value='N' checked> N </dd>";
    }
    else{
       echo "<dt><label>Aktif</label></dt>     <dd> : <input type=radio name='blokir' value='Y' checked> Y
...
case "detailpengajar":
    ...
    echo "<form><fieldset>
          ...
          if ($r[blokir]=='N'){
           echo "<dt><label>Aktif</label></dt>     <dd> :  N </dd>";
            }
            else{
           echo "<dt><label>Aktif</label></dt>     <dd> :  Y </dd>";
            }
