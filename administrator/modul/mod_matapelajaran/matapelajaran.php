...
// Tampil Mata Pelajaran
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<br><center><h3>Pengelolaan Mata Pelajaran</h3><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=matapelajaran&act=tambahmatapelajaran';\">";
    ...
    while ($r=mysql_fetch_array($tampil_pelajaran)){
       echo "<tr><td>$no</td>
             ...
             <td><a href='?module=matapelajaran&act=editmatapelajaran&id=$r[id]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=matapelajaran&act=hapus&id=$r[id]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a></td></tr>";
      $no++;
    }
    echo "</table>";
    }
  ...
  if (!empty($cek_mapel)){
    echo"<center><h2>Mata Pelajaran Yang di Ampu</h2><hr></center>
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        ...
        echo"<br><center><h1>Mata Pelajaran Kelas Anda</h1></center><br><p class='garisbawah'></p>";
        echo "<table>
...
case "tambahmatapelajaran":
    if ($_SESSION[leveluser]=='admin'){
        echo "<form method=POST action='$aksi?module=matapelajaran&act=input_matapelajaran'>
          <fieldset>
          <center><h1>Tambah Mata Pelajaran</h1></center>
          <dl class='inline'>
...
case "editmatapelajaran":
    if ($_SESSION[leveluser]=='admin'){
        ...
        echo "
          ...
          <fieldset>
          <center><h1>Edit Mata Pelajaran </h1></center>
          <dl class='inline'>
