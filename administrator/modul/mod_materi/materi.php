...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
        ...
        if(!empty($cek_materi)){
        echo "<br><center><h3>Manajemen Materi</h3><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=materi&act=tambahmateri';\">";
    ...
    while ($r=mysql_fetch_array($tampil_materi)){
      $tgl_posting   = tgl_indo($r[tgl_posting]);
       echo "<tr><td>$no</td>
             ...
             echo"<td>$r[hits]</td>
             <td><a href='?module=materi&act=editmateri&id=$r[id_file]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=materi&act=hapus&id=$r[id_file]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a></td></tr>";
      $no++;
    }
    echo "</table>";
 ...
 elseif ($_SESSION[leveluser]=='pengajar'){        
    ...
    $cek_materi = mysql_query("SELECT * FROM file_materi WHERE pembuat = '$_SESSION[idpengajar]'");
     ...
     echo "<center><h2>Daftar Materi Yang diUpload</h2><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=materi&act=tambahmateri';\">";
     echo "<br><br><table id='table1' class='gtable sortable'><thead>
    ...
    echo"</table>";   
        ...
        echo"<br><h1><center>Materi Pembelajaran</center></h1><br><p class='garisbawah'></p>";
