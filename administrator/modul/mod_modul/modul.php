...
switch($_GET[act]){
  ...
  default:
    ...
    echo "<center><h3>Pengelolaan Data Modules</h3><hr></center>
          <input class='button blue' type=button value='Tambah' onclick=\"window.location.href='?module=modul&act=tambahmodul';\"><br /><br />
