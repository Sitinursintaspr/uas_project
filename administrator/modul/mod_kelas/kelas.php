...
switch($_GET[act]){
  ...
  default:
    if ($_SESSION[leveluser]=='admin'){
      ...
      echo "<br><center><h3>Pengelolaan Data Kelas</h3><hr></center>
          <input type=button class='button blue' value='Tambah' onclick=\"window.location.href='?module=kelas&act=tambahkelas';\">";
    ...
    while ($r=mysql_fetch_array($tampil)){       
       echo "<tr><td>$no</td>
             ...
             echo "<td><a href='?module=kelas&act=editkelas&id=$r[id]' title='Edit'><img src='images/icons/edit2.png' alt='Edit' /></a> |
                 <a href=javascript:confirmdelete('$aksi?module=kelas&act=hapuskelas&id=$r[id]') title='Hapus'><img src='images/icons/delete1.png' alt='Delete' /></a> |
    ...
    elseif ($_SESSION[leveluser]=='pengajar'){
         echo"<center><h2>Kelas yang di ampu</h2><hr></center>
         <input type=button class='button blue' value='Tambah' onclick=\"window.location.href='?module=kelas&act=tambahkelas';\">";
    ...
    elseif ($_SESSION[leveluser]=='siswa'){
        echo"<br><center><h1>Kelas Anda</h1></center><br><p class='garisbawah'></p>";
       ...
       echo "<tr>
             ...
             echo "<td><input type=button class='tombol' value='Edit'
          onclick=\"window.location.href='?module=kelas&act=editkelas&id=$r[id]';\">
          <input type=button class='tombol' value='Lihat'
          onclick=\"window.location.href='?module=siswa&act=lihatmurid&id=$r[id_kelas]';\">
          </td></tr>";
      $no++;
    }
    echo "</table> <input type=button value=Kembali onclick=self.history.back()>";
    ...
    echo "<form method=POST action='$aksi?module=kelas&act=update_kelas'>
          ...
          <fieldset>
          <center><h1>Kelas Anda</h1></center>
          <dl class='inline'>
