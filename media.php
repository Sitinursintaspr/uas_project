...
if($_SESSION[login]==0){
  echo "<link href='css/new_screen.css' rel='stylesheet' type='text/css'>
...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser']) AND $_SESSION['login']==0){
  echo "<link href='css/new_screen.css' rel='stylesheet' type='text/css'><link href='css/reset.css' rel='stylesheet' type='text/css'>
...
<link type="text/css" rel="stylesheet" media="all" href="css/screen_new.css" />
...
<body onload="startclock()">
	...
	<div class="sidebar">
		...
		<center>&nbsp;&nbsp;<img src="foto_siswa/<?php echo "$_SESSION[fotosiswa]";?>" height='200px' width='200px'>&nbsp;&nbsp;</center>
		<center><strong><a size='20px'><?php echo "$_SESSION[namalengkap]";?></a></strong>&nbsp;&nbsp;</center>
		...
		<div class="menu">
		  <ul>
		  	<li><CENTER><strong>AKUN ANDA</strong></CENTER>
			    <ul>
				  <?php include "menu2.php"; ?>
				</ul>
			</li>
				 
		  	<li><CENTER><strong>MENU UTAMA</strong></CENTER>
			  <ul>
	...
	<div class="main-wrap">
		<div class="header clear">
			<ul class="links clear">
				<li><img src="images/hhh.png" margin-top="15px"; height="15px"; width="20px"><span class="text"><strong>    
					Welcome, <?php echo "$_SESSION[namalengkap]";?></strong></span>&nbsp;&nbsp;</li>
				<li><a href="?module=home"><img src="images/h.png" alt="" class="icon"  title="Home" /> <span class="text"></span></a></li>
				<li><a href="logout.php"><img src="images/hh.png" alt="" class="icon" title="Logout" /> 
